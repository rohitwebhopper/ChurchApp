    ...
    <div className={styles.container}>
      <div className={styles.topBar}>
         <div className="flex items-center gap-2 mb-4">
             <FaUserShield className="text-2xl" style={{color:"var(--secondary_black)"}} />
             <h2 className="text-xl " style={{fontFamily:"var( --font-marcellus)", fontWeight:"600"}}>Roles</h2>
           </div>

      <Button size='small' onClick={() => navigate('/management/roles/create')}>Create New Role</Button>
      </div>
